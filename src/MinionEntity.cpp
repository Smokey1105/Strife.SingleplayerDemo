...
{
    renderer->RenderCircleOutline(Center(), engagementRadius, Color::Red(), -1);
    renderer->RenderCircleOutline(Center(), reach, Color::Red(), -1);
    renderer->RenderRectangle(Rectangle(Center() - Dimensions() / 2, Dimensions()), Color::Red(), -0.99);
}
